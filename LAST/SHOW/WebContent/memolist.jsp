...
<a href="memoUpdateView.jsp"><font color="white"><%=rs.getString(1)%> </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><br>
...
%>
        ...
        <!-- 글쓰기 -->
        <FORM action="memo.jsp" method="post" style="float: right;margin-top: -850px; margin-right: 80px; text-align: center;">
            <center>
