...
%>
        ...
        <!-- 글쓰기 -->
        <FORM action="memo.jsp" method="post" style="float: right; margin-top: 80px; margin-right: 80px; text-align: center;">
                <div class="memo" style="background-color:  rgba(200,200,200,0.03);">
                    <div style="margin-top: 17px; margin-left: 20px;">제목</div>
                    <textarea name="title" id="title" placeholder="제목을 입력해 주세요."></textarea>
               ...
               <button id="addMemo" style="margin-left: -1150px; margin-top: 600px;">추가</button>
